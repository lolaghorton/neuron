...
if __name__ == "__main__":
	...
	if not os.path.exists(f'./data/i3p-f1/Data_F1_F6_S1_processed.pickle'):
		na_data = util.pickle_load(f'./data/i3p-f1/Data_F1_F6_S1_Na_responses.pickle')
		nmda_data = util.pickle_load(f'./data/i3p-f1/Data_F1_F6_S1_NMDA_noNa_responses.pickle')
		print('Loaded raw data...')
		process_traces = True
	else:
		(na_thresholds,nmda_thresholds,na_maxima,na_maxima_backup,nmda_na_maxima,dendrite_NRLEs,traces_to_visualize_basal,traces_to_visualize_apical) = util.pickle_load(f'./data/i3p-f1/Data_F1_F6_S1_processed.pickle')
	...
	if process_traces:
		...
		util.pickle_dump((na_thresholds,nmda_thresholds,na_maxima,na_maxima_backup,nmda_na_maxima,dendrite_NRLEs,traces_to_visualize_basal,traces_to_visualize_apical), f'./data/i3p-f1/Data_F1_F6_S1_processed.pickle')
