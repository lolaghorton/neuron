...
ctrl_rates, ctrl_stds, _, _, ctrl_rates_all = util.pickle_load('./data/oritune-f2a/firing_rates_stds_cnd600.pickle')

if itype == 0 :
	raise Exception
if itype == 1:
	filepath = './data/synint-f4/4a/intv_control_cnd600_delFB_nsA.pickle'
	directory = './data/synint-f4/4a'
	filepath2 = './data/synint-f4/4a/intv_control_cnd600_delFB_nsB.pickle'
	affix = '_syn_removal'
