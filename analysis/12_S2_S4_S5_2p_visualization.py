...
if os.path.exists(f'./{spot}/Data_F2_bins_2p.pickle') and os.path.exists(f'./{spot}/Data_F2_distribution_2p.pickle'):
	x_d = util.pickle_load(f'./{spot}/Data_F2_bins_2p.pickle')
	distr_all_d = util.pickle_load(f'./{spot}/Data_F2_distribution_2p.pickle')
else:
	raise IOError
...
#%% Figure 2D
[aggregate_somata, aggregate_dendrites, averaged_somata, averaged_dendrites, n_somata, n_dendrites, err_somata, err_dendrites] = util.pickle_load(f'./{spot}/Data_F2_allcells_STA.pickle')
window_left = 5
window_right = 10
...
#%% Supp.Figure 4B
[aggregate_somata, aggregate_dendrites, averaged_somata, averaged_dendrites, n_somata, n_dendrites, err_somata, err_dendrites] = util.pickle_load(f'./{spot}/Data_F2_mouse1_STA.pickle')
plt.sca(axes['B1'])
# fig = plt.figure(dpi = __RES_DPI)
...
#%% Supp.Figure 4C
[aggregate_somata, aggregate_dendrites, averaged_somata, averaged_dendrites, n_somata, n_dendrites, err_somata, err_dendrites] = util.pickle_load(f'./{spot}/Data_F2_mouse2_STA.pickle')
plt.sca(axes['C1'])
# fig = plt.figure(dpi = __RES_DPI)
...
if os.path.exists(f'./{spot}/Data_S4_bins_null.pickle') and os.path.exists(f'./{spot}/Data_S4_distribution_null.pickle'):
	x_d = util.pickle_load(f'./{spot}/Data_S4_bins_null.pickle')
	distr_all_d = util.pickle_load(f'./{spot}/Data_S4_distribution_null.pickle')
else:
	raise IOError
