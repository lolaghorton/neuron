...
ctrl_rates, ctrl_stds, _, _, _ = util.pickle_load('./data/synint-f4/intv_control_cnd600_delFB.pickle')
#ctrl_rates, ctrl_stds, _, _, _ = util.pickle_load('./data/synint-f4/firing_rates_stds_cnd600.pickle')
filepath = './data/synint-f4/spike_survival_verdicts_revisions_syn_intv.pickle'
directory = './data/synint-f4'
filepath2 = './data/synint-f4/pre_intervention_spike_timings_revisions_syn_intv.pickle'
affix = '_syn_intv'
...
for comparison in range(0,1):
	...
	res = test_stats_add_stars_generic(_labels,OSIs_aggregated,0,0.07,0,-0.1,comparewith=[0,1,2])
		
	
axTC.set_title(f'Figure 4B')
