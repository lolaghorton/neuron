...
# Paths for +/- 10% (changed itype 0 to apical only, with fbdelay)
ctrl_rates, ctrl_stds, _, _, _ = util.pickle_load('./Data/S7/intv_control_cnd600_na_weighted_m10A_fbdel.pickle')
filepath = './Data/S7/spike_survival_verdicts_m10A_na_intv.pickle'
directory = './Data/S7/'
filepath2 = './Data/S7/pre_intervention_spike_timings_m10A_na_intv.pickle'
affix = '_m10A_intv'
...
axTC.set_title(f'Supp.Figure 7B')
