...
if __name__ == '__main__':
	...
	(na_thresholds,nmda_thresholds,na_maxima,na_maxima_backup,nmda_na_maxima,dendrite_NRLEs,traces_to_visualize_basal,traces_to_visualize_apical) = util.pickle_load('./data/figure5/pet18-5sabef/Data_F1_F6_S1_processed.pickle')
	...
	amp_data = util.pickle_load('./data/figure5/pet18-5sabef/amp_data_dspikes.pickle')
