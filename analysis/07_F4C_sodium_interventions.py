...
ctrl_rates, ctrl_stds, _, _, _ = util.pickle_load('./Data/F4/intv_control_cnd600_delFB.pickle')
filepath = './Data/F4/spike_survival_verdicts_revisions_na_intv.pickle'
directory = './Data/F4/'
filepath2 = './Data/F4/pre_intervention_spike_timings_revisions_na_intv.pickle'
affix = '_na_intv'
...
axTC.set_title(f'Figure 4C / Supp.Figure 7C')
