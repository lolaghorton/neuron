...
filepath_root = './data/ionint-f3'

filepath_fixednoise = f'{filepath_root}/fn_spike_survival_verdicts_revisions_na_intv.pickle'
filepath_variablenoise = f'{filepath_root}/vn_spike_survival_verdicts_revisions_na_intv.pickle'
