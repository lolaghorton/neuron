...
#	(na_thresholds,nmda_thresholds,na_maxima,na_maxima_backup,nmda_na_maxima,dendrite_NRLEs,traces_to_visualize_basal,traces_to_visualize_apical) = util.pickle_load('./Data/F1/Data_F1_F5_S1.pickle')
	(na_thresholds,nmda_thresholds,na_maxima,na_maxima_backup,nmda_na_maxima,dendrite_NRLEs,traces_to_visualize_basal,traces_to_visualize_apical) = util.pickle_load('./data/figure5/pet09-5cd/Data_F1_F6_S1_processed.pickle')
	#^^not sure if there is a difference between these tbh
	...
	amp_data = util.pickle_load('./data/figure5/pet09-5cd/amp_data_thresholds.pickle')
